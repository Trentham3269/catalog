...
INSERT INTO items (id, title, description, cat_id) VALUES (5, 'Wooden bat', 'What a beautiful piece of hickory', 3);
...
INSERT INTO items (id, title, description, cat_id) VALUES (11, 'Rope', 'Supports a climber up to 150kgs (as long as their fingers do)', 6);
...
INSERT INTO items (id, title, description, cat_id) VALUES (19, 'Shin pads', 'Necessary for the times when not faking injury', 1);
INSERT INTO items (id, title, description, cat_id) VALUES (20, 'Mitt', 'Specifically designed for those with butter fingers', 3);
INSERT INTO items (id, title, description, cat_id) VALUES (21, 'Wax', 'Protect what is probably your only investment', 8);
INSERT INTO items (id, title, description, cat_id) VALUES (22, 'Puck', 'Without this hockey could just be called fighting on ice', 9);
INSERT INTO items (id, title, description, cat_id) VALUES (23, 'Ski poles', 'With these you can create a new hybrid sport', 5);
INSERT INTO items (id, title, description, cat_id) VALUES (24, 'Metal bat', 'What a beautiful hunk of metal', 3);
INSERT INTO items (id, title, description, cat_id) VALUES (25, 'Cleats', 'Engineered by NASA for maximum grip on AstroTurf', 7);
