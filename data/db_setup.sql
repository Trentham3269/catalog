...
INSERT INTO users (id, email) VALUES (1, 'scottdalwood@gmail.com');
...
INSERT INTO items (id, title, description, cat_id, user_id) VALUES (4, 'Net', 'The only net for that full swoosh sound', 2, 1);
...
INSERT INTO items (id, title, description, cat_id, user_id) VALUES (7, 'Frisbee', 'Well...duh!', 4, 1);
...
INSERT INTO items (id, title, description, cat_id, user_id) VALUES (14, 'Helmet', 'Best worn before your time in the concussion protocol', 7, 1);
...
INSERT INTO items (id, title, description, cat_id, user_id) VALUES (18, 'Ice skates', 'Well that explains the stick type', 9, 1);
...
INSERT INTO items (id, title, description, cat_id, user_id) VALUES (22, 'Puck', 'Without this hockey could just be called fighting on ice', 9, 1);
